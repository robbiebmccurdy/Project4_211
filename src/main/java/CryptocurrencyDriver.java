...
public class CryptocurrencyDriver  {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException{	
		...
		myBitcoin.buy(new Coin(15.0, "secret"));
		myBitcoin.buy(new Coin(20.0, "hello"));
		myBitcoin.buy(new Coin(25.0, "goodbye"));
		myBitcoin.buy(new Coin(30.0, "tomorrow"));
		myBitcoin.buy(new Coin(7.0, "today"));
